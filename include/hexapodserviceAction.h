...
#include "../include/hexapodserviceActionGoal.h"
#include "../include/hexapodserviceActionResult.h"
#include "../include/hexapodserviceActionFeedback.h"
...
struct MD5Sum< ::hexapodservice::hexapodserviceAction_<ContainerAllocator> >
{
  ...
  {
    return "004abf930406a06c885a35bef9a175af";
  }

  static const char* value(const ::hexapodservice::hexapodserviceAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x004abf930406a06cULL;
  static const uint64_t static_value2 = 0x885a35bef9a175afULL;
};
